//MAS INFO SOBRE PROMESAS: https://es.javascript.info/promise-basics
...
const getUser = (id) => {
    ...
    return promise // El return se puede colocar en lugar del "const", se ve en la proxima function
}
